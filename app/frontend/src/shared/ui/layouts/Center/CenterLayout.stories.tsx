...
const MessageCard = ({
  ...
  return (
    <div className={`max-w-md mx-auto p-6 rounded-lg border ${colors[type]}`}>
      <div className="text-center">
...
export const SuccessMessage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Great for success messages and confirmation pages.',
      },
    },
  },
};
...
export const LoadingState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Ideal for loading states and processing pages.',
      },
    },
  },
};
...
export const CompactContent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Works great with compact content and small cards.',
      },
    },
  },
};
...
export const MultipleElements: Story = {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium text-gray-900 dark:text-gray-100">Profile Created</h3>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Can handle multiple elements while maintaining centered layout.',
      },
    },
  },
};
...
export const WithCustomStyling: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Center layout with custom background styling applied.',
      },
    },
  },
};
...
export const ResponsiveDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Responsive behavior of the center layout across different screen sizes.',
      },
    },
  },
};
