...
Frontend приложение построено с использованием React 19, TypeScript, Vite и
следует архитектуре Feature-Sliced Design (FSD). Приложение предоставляет
интерфейс для генерации аватаров с поддержкой различных типов генераторов.
...
**Расположение:**
`src/features/avatar-generator/ui/EmojiAvatarGeneratorForm.tsx`
...
**Расположение:**
`src/features/avatar-generator/contexts/AvatarGeneratorContext.tsx`
