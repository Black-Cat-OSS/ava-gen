...
/**
 * Component for displaying current palette information
 * Shows primary and foreign colors with their hex values
    ...
    <div className="p-4 bg-card border rounded-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex items-center gap-3">
          <div
            className="w-10 h-10 rounded-full border-2 border-border shadow-sm flex-shrink-0"
            style={{ backgroundColor: currentPalette.foreignColor }}
          />
          <div className="text-sm min-w-0">
            <p className="font-medium text-foreground">
