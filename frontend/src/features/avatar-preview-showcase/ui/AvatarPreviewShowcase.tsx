...
import { AvatarShapeProvider } from '../contexts';
import { PREVIEW_CONTEXTS } from '../constants/preview-contexts';
import { PreviewCard } from './PreviewCard';
import { AvatarShapeToggle } from './AvatarShapeToggle';
import type { AvatarPreviewShowcaseProps } from '../types';
 ...
 */
export const AvatarPreviewShowcase: React.FC<AvatarPreviewShowcaseProps> = ({
  className = '',
}) => {
          ...
          <div className="mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {PREVIEW_CONTEXTS.map((context, index) => {
                ...
                // Use a fallback avatar for preview
