    ...
    <div className="mb-8 bg-card border rounded-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <p className="text-muted-foreground">{new Date(avatar.createdAt).toLocaleString()}</p>
        </div>
        {avatar.primaryColor && (
          <div>
            <strong className="text-foreground">{t('pages.avatarViewer.primaryColor')}:</strong>
        ...
        {avatar.foreignColor && (
          <div>
            <strong className="text-foreground">{t('pages.avatarViewer.foreignColor')}:</strong>
            <div className="flex items-center gap-2 mt-1">
              <div
                className="w-4 h-4 rounded border border-border"
        ...
        {avatar.colorScheme && (
          <div>
            <strong className="text-foreground">{t('pages.avatarViewer.colorScheme')}:</strong>
