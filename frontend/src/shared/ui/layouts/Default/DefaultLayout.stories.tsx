...
const SampleContent = ({
  ...
  <div className="py-12">
    <div className="text-center mb-8">
      ...
      <p className="mt-4 text-lg leading-6 text-gray-600 dark:text-gray-300">{description}</p>
    </div>
...
export const MinimalContent: Story = {
    ...
    <DefaultLayoutStorybook>
      <div className="py-12 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          This shows how the layout behaves with minimal content.
        </p>
      </div>
    </DefaultLayoutStorybook>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Layout with minimal content to show vertical centering and spacing.',
      },
    },
  },
};
...
export const WithCustomStyling: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Layout with custom background styling applied to the container.',
      },
    },
  },
};
...
export const FormLayout: Story = {
    ...
    <DefaultLayoutStorybook>
      <div className="py-12">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-8">Contact Form</h1>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Layout optimized for form content with proper constraints and spacing.',
      },
    },
  },
};
